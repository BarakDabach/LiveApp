...
//				       sortInbox.setModel(new DefaultComboBoxModel(msgNames));
				       ...
				       inboxFrm.add(deleteMsgBtn);
						...
						sortDefects.setBounds(279, 240, 148, 22);
						...
						defectTable.setGridColor(new Color(51, 51, 51));
						       ...
						       tablePanel.setBounds(new Rectangle(92, 300, 508, 229));
					...
					public void mouseExited(MouseEvent e) {
						btnRemoveDefect.setBackground(new Color(0,0, 0));
						       ...
						       lblSortBy.setBounds(329, 213, 61, 22);
						       DefectFrm.add(lblSortBy);
						       
						       JPanel headerPanel = new JPanel();
						       headerPanel.setBounds(0, 0, 973, 100);
						       DefectFrm.add(headerPanel);
						       headerPanel.setBackground(new Color(101, 26, 163));
						       headerPanel.setLayout(null);
						       
						       lblDefectsStatus = new JLabel("Building Defects");
						       lblDefectsStatus.setBounds(22, 30, 207, 38);
						       headerPanel.add(lblDefectsStatus);
						       lblDefectsStatus.setForeground(new Color(255, 255, 255));
						       lblDefectsStatus.setHorizontalAlignment(SwingConstants.CENTER);
						       lblDefectsStatus.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 23));
