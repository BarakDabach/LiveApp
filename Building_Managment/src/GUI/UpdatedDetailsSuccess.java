...
public class UpdatedDetailsSuccess {
	...
	private void initialize() {
		...
		JLabel lblDetailsAreIncorrect = new JLabel("Updated Successfully");
		...
		panel.add(label);
		label.setIcon(new ImageIcon(UpdatedDetailsSuccess.class.getResource("/Media/uploadSuccess.png")));
